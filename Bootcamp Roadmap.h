...
// HINT: Remove gTest -> Use "cmake converter" 
// 		-> remove the artifacts that are not working (on windows/linux) such as Utils.cmake (where did it came from anyway?) 
//		-> use SO instead of DLL on linux 
//		-> Use cross platform C++ libraries instead of something windows specific (like std::thread, std::filesystem, etc)
//		-> You can add back google test here , OR, use Catch2: https://github.com/catchorg/Catch2/tree/v3.4.0 which is simpler to integrate
...
// TASK *: Create "Admin" UI with the QT library, that shows the images and detections from the camera.
